...
export function TeamPage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <Card className="bg-[#161b22] border-white/5">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-[#8b949e] mb-1">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-[10px]">Total Agents</span>
              </div>
          ...
          <Card className="bg-[#161b22] border-white/5">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-[#8b949e] mb-1">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-[10px]">Active Tasks</span>
              </div>
          ...
          <Card className="bg-[#161b22] border-white/5">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-[#8b949e] mb-1">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-[10px]">Completed</span>
              </div>
          ...
          <Card className="bg-[#161b22] border-white/5">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-[#8b949e] mb-1">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-[10px]">Success Rate</span>
              </div>
      ...
      {/* Agent Cards Grid */}
      <div>
        <h2 className="text-[10px] font-bold text-[#8b949e] uppercase tracking-[0.2em] mb-4">Employees</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
          {agents.map((agent) => (
            <Card
              key={agent.id}
              className="bg-[#161b22] border-white/5 hover:border-primary/30 transition-all cursor-pointer group"
