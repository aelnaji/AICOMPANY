...
export function ConnectorsPage() {
  ...
  // Derived from editingConnector — safe to use anywhere in the component
  const dialogIsConnected = editingConnector?.isConnected ?? false;
      ...
      <Dialog open={configDialogOpen} onOpenChange={setConfigDialogOpen}>
        <DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto">
          ...
          <DialogFooter className="gap-2">
            ...
            >
              {saving ? "Saving..." : dialogIsConnected ? "Update" : "Connect"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
